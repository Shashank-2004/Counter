...
const App = () => {
  ...
  return (
      ...
      <div className="bg-sky-400 backdrop-blur-lg border border-white/30 text-center p-6 rounded-3xl w-[90%] max-w-sm shadow-xl">
      <div className='flex mb-4 justify-center'>
        ...
        <button 
            onClick={addValue} 
            className="bg-purple-500 text-white w-40 py-2 rounded-2xl text-xl 
